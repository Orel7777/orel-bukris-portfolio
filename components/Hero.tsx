    ...
    <div>
      <div>
        <div>
          ...
          />
          <Spotlight
            className="top-28 left-80 h-[80vh] w-
            [50vw]"
            fill="blue"
          />
        </div>
    ...
    <div className="h-screen w-full dark:bg-black-100
      ...
      <div className="flex justify-center relative my-1  z-10">
        <div className="max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center ">
            <h2 className=" tracking-widest text-xs text-center text-blue-100 max-w-80">Orel Bukris | Building Engaging User Interfaces</h2>
            <TextGenerateEffect
            className="text-center text-[40px] md:text-5xl lg:test-6xl"
            words="Turning Ideas into Smooth User Experiences"
            />
